...
(
  function(_global, factory) {
    ...
    function hsl2rgb(hsl) {
      ...
      const s = hsl[1] / 100;
      const l = hsl[2] / 100;
      let t1; let t2; let t3; let rgb; let val;
  ...
  compute it */
    ...
    ['rgb', 'hsl', 'hsv', 'cmyk', 'keyword'].forEach(function(space) {
      Converter.prototype[space] = function(_vals) {
 ...
 */
   ...
   */
      merge: function(target, source, options) {
        ...
        let merge; let i; let keys; let klen; let k;
 ...
 */
   ...
   */
      ...
      drawPoint: function(ctx, style, radius, x, y, rotation) {
        let type; let xOffset; let yOffset; let size; let cornerRadius;
 ...
 */
   ...
   * @return {number} The effective line height in pixels (size * 1.2 if value is invalid).
   ...
   * @return {object} The padding values (top, right, bottom, left, width, height)
   * @since 2.7.0
   */
   ...
   */
    ...
    function interpolate(start, view, model, ease) {
      ...
      let i; let ilen; let key; let actual; let origin; let target; let type; let c0; let c1;
    ...
    const exports$2 = core_element.extend({
    ...
    const core_animation = exports$2;
 ...
 */
   ...
   */
      advance: function() {
        const animations = this.animations;
        let animation; let chart; let numSteps; let nextStep;
        let i = 0;
   ...
   */
    ...
    const element_line = core_element.extend({
      draw: function() {
        ...
        let index; let current; let previous; let currentVM;
 ...
 */
    function getBarBounds(vm) {
      let x1; let x2; let y1; let y2; let half;
 ...
 */
    function computeMinSampleSize(scale, pixels) {
      ...
      let prev; let curr; let i; let ilen;
 ...
 */
    ...
    const controller_bar = core_datasetController.extend({
      ...
      updateElement: function(rectangle, index, reset) {
        ...
        const meta = me.getMeta();
        const dataset = me.getDataset();
        const options = me._resolveElementOptions(rectangle, index);
   ...
   * @return {string[]} The list of stack IDs
   * @private
   */
   ...
   */
      calculateBarValuePixels: function(datasetIndex, index) {
        ...
        const minBarLength = scale.options.minBarLength;
        const stacked = scale.options.stacked;
        const stack = meta.stack;
        let start = 0;
        let i; let imeta; let ivalue; let base; let head; let size;
   ...
   */
          ...
          generateLabels: function(chart) {
            ...
            if (data.labels.length && data.datasets.length) {
              return data.labels.map(function(label, i) {
                ...
                const fill = resolve$3([custom.backgroundColor, ds.backgroundColor, arcOpts.backgroundColor], undefined, i);
                const stroke = resolve$3([custom.borderColor, ds.borderColor, arcOpts.borderColor], undefined, i);
                const bw = resolve$3([custom.borderWidth, ds.borderWidth, arcOpts.borderWidth], undefined, i);
    ...
    const controller_doughnut = core_datasetController.extend({
      ...
      getMaxBorderWidth: function(arcs) {
        ...
        let max = 0;
        const chart = me.chart;
        let i; let ilen; let meta; let arc; let controller; let options; let borderWidth; let hoverWidth;
   ...
   */
      _resolveElementOptions: function(arc, index) {
        ...
        const options = chart.options.elements.arc;
        const values = {};
        let i; let ilen; let key;
   ...
   */
    ...
    const controller_line = core_datasetController.extend({
      ...
      update: function(reset) {
        ...
        const dataset = me.getDataset();
        const showLine = lineEnabled(dataset, me.chart.options);
        let i; let ilen;
   ...
   */
      ...
      updateBezierControlPoints: function() {
        ...
        let i; let ilen; let model; let controlPoints;
          ...
          generateLabels: function(chart) {
            ...
            if (data.labels.length && data.datasets.length) {
              return data.labels.map(function(label, i) {
                ...
                const custom = arc.custom || {};
                const arcOpts = chart.options.elements.arc;
                const fill = resolve$5([custom.backgroundColor, ds.backgroundColor, arcOpts.backgroundColor], undefined, i);
                const stroke = resolve$5([custom.borderColor, ds.borderColor, arcOpts.borderColor], undefined, i);
                const bw = resolve$5([custom.borderWidth, ds.borderWidth, arcOpts.borderWidth], undefined, i);
   ...
   */
    ...
    const resolve$6 = helpers$1.options.resolve;
   ...
   */
      _resolveLineOptions: function(element) {
        ...
        const dataset = chart.data.datasets[me.index];
        const custom = element.custom || {};
        const options = chart.options.elements.line;
        const values = {};
        let i; let ilen; let key;
 ...
 */
    function parseVisibleItems(chart, handler) {
      const datasets = chart.data.datasets;
      let meta; let i; let j; let ilen; let jlen;
 ...
 */
   ...
   */
      configure: function(_chart, item, options) {
   ...
   */
      update: function(chart, width, height) {
        ...
        const verticalBoxes = leftBoxes.concat(rightBoxes);
        const horizontalBoxes = topBoxes.concat(bottomBoxes);
        const outerBoxes = verticalBoxes.concat(horizontalBoxes);
        ...
        // Step 2
        const verticalBoxWidth = (width - chartAreaWidth) / verticalBoxes.length;
        ...
        let outerBoxSizes = {top: topPadding, left: leftPadding, bottom: bottomPadding, right: rightPadding};
        const minBoxSizes = [];
        let maxPadding;
        ...
        function fitBox(box) {
          const minBoxSize = helpers$1.findNextWhere(minBoxSizes, function(minBox) {
        ...
        function finalFitVerticalBox(box) {
          const minBoxSize = helpers$1.findNextWhere(minBoxSizes, function(minSize) {
        ...
        const leftPaddingAddition = Math.max(maxPadding.left - outerBoxSizes.left, 0);
        outerBoxSizes.left += leftPaddingAddition;
        outerBoxSizes.right += Math.max(maxPadding.right - outerBoxSizes.right, 0);

        const topPaddingAddition = Math.max(maxPadding.top - outerBoxSizes.top, 0);
        ...
        const newMaxChartAreaHeight = height - outerBoxSizes.top - outerBoxSizes.bottom;
        const newMaxChartAreaWidth = width - outerBoxSizes.left - outerBoxSizes.right;
 ...
 * @return {number} Size in pixels or undefined if unknown.
 */
 ...
 */
   ...
   * @return {CanvasRenderingContext2D} context2d instance
   */
   ...
   * @return {boolean} true if the method succeeded, else false
   */
 ...
 */
   ...
   * @return {IPlugin[]} array of plugin objects.
   * @since 2.1.5
   */
      getAll: function() {
   ...
   * @return {boolean} false if any of the plugins return false, else returns true.
   */
      notify: function(chart, hook, args) {
        const descriptors = this.descriptors(chart);
        const ilen = descriptors.length;
        let i; let descriptor; let plugin; let params; let method;
   ...
   * @return {object} tooltip position
   */
   ...
   * @return {object} the tooltip position
   */
      nearest: function(elements, eventPosition) {
        let x = eventPosition.x;
        let y = eventPosition.y;
        let minDistance = Number.POSITIVE_INFINITY;
        let i; let len; let nearestElement;
 ...
 * @return {string[]} value if newline present - Returned from String split() method
 * @function
 */
 ...
 */
    ...
    const exports$3 = core_element.extend({
      ...
      getCaretPosition: function(tooltipPoint, size, vm) {
        let x1; let x2; let x3; let y1; let y2; let y3;
        const caretSize = vm.caretSize;
        const cornerRadius = vm.cornerRadius;
      ...
      drawTitle: function(pt, vm, ctx) {
        ...
        if (title.length) {
          ...
          const titleFontSize = vm.titleFontSize;
          const titleSpacing = vm.titleSpacing;
   ...
   * @return {boolean} true if the tooltip changed
   */
 ...
 */
   ...
   */
      buildOrUpdateScales: function() {
        ...
        helpers$1.each(items, function(item) {
          ...
          const scaleType = valueOrDefault$8(scaleOptions.type, item.dtype);
   ...
   */
      resetElements: function() {
        const me = this;
        helpers$1.each(me.data.datasets, function(_dataset, datasetIndex) {
  ...
  */
   ...
   */
      ...
      render: function(config) {
        ...
        const duration = valueOrDefault$8(config.duration, animationOptions && animationOptions.duration);
   ...
   */
      ...
      updateHoverStyle: function(elements, _mode, enabled) {
        const method = enabled ? 'setHoverStyle' : 'removeHoverStyle';
        let element; let i; let ilen;
 ...
 */
   ...
   * @return {number} The aligned pixel value.
   * @private
   */
      ...
      helpers$1.splineCurveMonotone = function(points) {
        ...
        let i; let pointBefore; let pointCurrent; let pointAfter;
        ...
        let alphaK; let betaK; let tauK; let squaredMagnitude;
 ...
 */
   ...
   */
     ...
     */
        linear: function(tickValue, _index, ticks) {
    ...
    const core_scale = core_element.extend({
      /**
   * Get the padding needed for the scale
   * @method getPadding
   * @private
   * @return {Padding} the necessary padding
   */
      getPadding: function() {
        const me = this;
        return {
   ...
   */
      ...
      update: function(maxWidth, maxHeight, margins) {
        const me = this;
        let i; let ilen; let labels; let label; let ticks; let tick;
      ...
      calculateTickRotation: function() {
        ...
        if (labels.length && me.options.display && me.isHorizontal()) {
          const originalLabelWidth = helpers$1.longestText(context, tickFont.string, labels, me.longestTextCache);
          let labelWidth = originalLabelWidth;
          let cosRotation; let sinRotation;
          ...
          while (labelWidth > tickWidth && labelRotation < tickOpts.maxRotation) {
            const angleRadians = helpers$1.toRadians(labelRotation);
      ...
      fit: function() {
        ...
        const parseFont = helpers$1.options._parseFont;
        const tickFont = parseFont(tickOpts);
        ...
        if (scaleLabelOpts.display && display) {
          const scaleLabelFont = parseFont(scaleLabelOpts);
          const scaleLabelPadding = helpers$1.options.toPadding(scaleLabelOpts.padding);
          const deltaHeight = scaleLabelFont.lineHeight + scaleLabelPadding.height;
        ...
        if (tickOpts.display && display) {
          let largestTextWidth = helpers$1.longestText(me.ctx, tickFont.string, labels, me.longestTextCache);
          const tallestLabelHeightInLines = helpers$1.numberOfLabelLines(labels);
          ...
          + lineSpace; // padding
            ...
            const firstLabelWidth = computeTextSize(me.ctx, labels[0], tickFont.string);
            const lastLabelWidth = computeTextSize(me.ctx, labels[labels.length - 1], tickFont.string);
            const offsetLeft = me.getPixelForTick(0) - me.left;
            const offsetRight = me.right - me.getPixelForTick(labels.length - 1);
   ...
   */
      getPixelForDecimal: function(decimal) {
        ...
        if (me.isHorizontal()) {
          ...
          let finalVal = me.left + valueOffset;
          finalVal += me.isFullWidth() ? me.margins.left : 0;
          return finalVal;
        }
   ...
   */
      _autoSkip: function(ticks) {
        ...
        let skipRatio = false;
        const maxTicks = optionTicks.maxTicksLimit;

        // Total space needed to display all ticks. First and last ticks are
        // drawn as their center at end of axis, so tickCount-1
        const ticksLength = me._tickSize() * (tickCount - 1);

        // Axis length
        const axisLength = isHorizontal
   ...
   */
      _tickSize: function() {
        ...
        const w = (me.longestLabelWidth + padding) || 0;

        const tickFont = helpers$1.options._parseFont(optionTicks);
        const h = (me._maxLabelLines * tickFont.lineHeight + padding) || 0;
   ...
   */
      draw: function(chartArea) {
        ...
        const context = me.ctx;
        const globalDefaults = core_defaults.global;
        const defaultFontColor = globalDefaults.defaultFontColor;
        ...
        const parseFont = helpers$1.options._parseFont;
        const ticks = optionTicks.display && optionTicks.autoSkip ? me._autoSkip(me.getTicks()) : me.getTicks();
        const tickFontColor = valueOrDefault$9(optionTicks.fontColor, defaultFontColor);
        const tickFont = parseFont(optionTicks);
        const lineHeight = tickFont.lineHeight;
        const majorTickFontColor = valueOrDefault$9(optionMajorTicks.fontColor, defaultFontColor);
        const majorTickFont = parseFont(optionMajorTicks);
        const tickPadding = optionTicks.padding;
        const labelOffset = optionTicks.labelOffset;

        const tl = gridLines.drawTicks ? gridLines.tickMarkLength : 0;

        const scaleLabelFontColor = valueOrDefault$9(scaleLabel.fontColor, defaultFontColor);
        const scaleLabelFont = parseFont(scaleLabel);
        const scaleLabelPadding = helpers$1.options.toPadding(scaleLabel.padding);
        const labelRotationRadians = helpers$1.toRadians(me.labelRotation);
        ...
        let borderValue; let tickStart; let tickEnd;
        ...
        const epsilon = 0.0000001; // 0.0000001 is margin in pixels for Accumulated error.
        ...
        helpers$1.each(ticks, function(tick, index) {
          ...
          // Common properties
          let tx1; let ty1; let tx2; let ty2; let x1; let y1; let x2; let y2; let labelX; let labelY; let textOffset; let textAlign;
          const labelCount = helpers$1.isArray(label) ? label.length : 1;
          const lineValue = getPixelForGridLine(me, index, gridLines.offsetGridLines);
          ...
          if (isHorizontal) {
            ...
            const labelXOffset = (isMirrored ? 0 : tl) + tickPadding;
        ...
        helpers$1.each(itemsToDraw, function(itemToDraw) {
          const glWidth = itemToDraw.glWidth;
          const glColor = itemToDraw.glColor;
        ...
        if (axisWidth) {
          ...
          const lastLineWidth = valueAtIndexOrDefault(gridLines.lineWidth, ticks.length - 1, 0);
 ...
 * @return {number[]} array of tick values
 */
    function generateTicks(generationOptions, dataRange) {
      ...
      let factor; let niceMin; let niceMax; let numSpaces;
    ...
    const scale_linear = scale_linearbase.extend({
      determineDataLimits: function() {
        ...
        if (hasStacks === undefined) {
          helpers$1.each(datasets, function(_dataset, datasetIndex) {
            if (hasStacks) {
              return;
            }
        ...
        if (opts.stacked || hasStacks) {
          ...
          helpers$1.each(valuesPerStack, function(valuesForType) {
            ...
            const minVal = helpers$1.min(values);
            const maxVal = helpers$1.max(values);
 ...
 */
    function generateTicks$1(generationOptions, dataRange) {
      ...
      let tickVal = valueOrDefault$a(generationOptions.min, Math.pow(10, Math.floor(helpers$1.log10(dataRange.min))));

      const endExp = Math.floor(helpers$1.log10(dataRange.max));
      const endSignificand = Math.ceil(dataRange.max / Math.pow(10, endExp));
      let exp; let significand;
      ...
      const lastTick = valueOrDefault$a(generationOptions.max, tickVal);
      ticks.push(lastTick);
   ...
   */
      _getFirstTickValue: function(value) {
        const exp = Math.floor(helpers$1.log10(value));
      ...
      getPixelForValue: function(value) {
        ...
        const log10 = helpers$1.log10;
        const firstTickValue = me._getFirstTickValue(me.minNotZero);
        let offset = 0;
        let innerDimension; let pixel; let start; let end; let sign;
      ...
      getValueForPixel: function(pixel) {
        ...
        const log10 = helpers$1.log10;
        const firstTickValue = me._getFirstTickValue(me.minNotZero);
        let innerDimension; let start; let end; let value;
        ...
        if (value !== start) {
          if (start === 0) { // include zero tick
            const offset = valueOrDefault$a(tickOpts.fontSize, core_defaults.global.defaultFontSize);
            value -= offset;
            innerDimension -= offset;
            start = firstTickValue;
          }
    ...
    const resolve$7 = helpers$1.options.resolve;
 ...
 */
    function fitWithPointLabels(scale) {
      ...
      let i; let textSize; let pointPosition;
    ...
    function drawPointLabels(scale) {
      ...
      const lineWidth = valueOrDefault$b(angleLineOpts.lineWidth, gridLineOpts.lineWidth);
      const lineColor = valueOrDefault$b(angleLineOpts.color, gridLineOpts.color);
        ...
        if (opts.display) {
          ...
          helpers$1.each(me.ticks, function(label, index) {
            ...
            if (index > 0 || tickOpts.reverse) {
              ...
              if (tickOpts.display) {
                const tickFontColor = valueOrDefault$b(tickOpts.fontColor, core_defaults.global.defaultFontColor);
 ...
 */
    function buildLookupTable(timestamps, min, max, distribution) {
      ...
      const table = [];
      const items = [min];
      let i; let ilen; let prev; let curr; let next;
 ...
 */
    function generate(scale, min, max, capacity) {
      ...
      let stepSize = valueOrDefault$c(timeOpts.stepSize, timeOpts.unitStepSize);
 ...
 */
    function computeOffsets(table, ticks, _min, _max, options) {
      let start = 0;
      let end = 0;
      let first; let last;
    ...
    function ticksFromTimestamps(scale, values, majorUnit) {
      const ticks = [];
      let i; let ilen; let value; let major;
   ...
   */
      ...
      determineDataLimits: function() {
        ...
        const datasets = [];
        let labels = [];
        let i; let j; let ilen; let jlen; let data; let timestamp;
   ...
   */
      tickFormatFunction: function(time, index, ticks, format) {
        ...
        const majorTime = +adapter.startOf(time, majorUnit);
        ...
        const formatter = valueOrDefault$c(tickOpts.callback, tickOpts.userCallback);
   ...
   */
      getPixelForOffset: function(time) {
        const me = this;
        const isReverse = me.options.ticks.reverse;
        const size = me._horizontal ? me.width : me.height;
        const start = me._horizontal ? isReverse ? me.right : me.left : isReverse ? me.bottom : me.top;
        const pos = interpolate$1(me._table, 'time', time, 'pos');
        const offset = size * (me._offsets.start + pos) / (me._offsets.start + 1 + me._offsets.end);
      ...
      getValueForPixel: function(pixel) {
        ...
        const pos = (size ? (pixel - start) / size : 0) * (me._offsets.start + 1 + me._offsets.start) - me._offsets.end;
   ...
   */
      getLabelWidth: function(label) {
        ...
        const angle = helpers$1.toRadians(ticksOpts.maxRotation);
        const cosRotation = Math.cos(angle);
        const sinRotation = Math.sin(angle);
        const tickFontSize = valueOrDefault$c(ticksOpts.fontSize, core_defaults.global.defaultFontSize);
   ...
   */
      getLabelCapacity: function(exampleTime) {
        ...
        const format = me.options.time.displayFormats.millisecond;
        const exampleLabel = me.tickFormatFunction(exampleTime, 0, [], format);
   ...
   */
    ...
    const mappers = {
      dataset: function(source) {
        ...
        return !length ? null : function(_point, i) {
    ...
    function doFill(ctx, points, mapper, view, color, loop) {
      ...
      let len0 = 0;
      let len1 = 0;
      let i; let ilen; let index; let p0; let p1; let d0; let d1;
    ...
    const plugin_filler = {
      ...
      afterDatasetsUpdate: function(chart, options) {
        ...
        const sources = [];
        let meta; let i; let el; let source;
      ...
      beforeDatasetDraw: function(chart, args) {
        ...
        const color = view.backgroundColor || core_defaults.global.defaultColor;
    ...
    const Legend = core_element.extend({
      ...
      */
      ...
      draw: function() {
        ...
        if (opts.display) {
          const ctx = me.ctx;
          const fontColor = valueOrDefault$d(labelOpts.fontColor, globalDefaults.defaultFontColor);
          const labelFont = helpers$1.options._parseFont(labelOpts);
          const fontSize = labelFont.size;
          let cursor;
          ...
          const drawLegendBox = function(x, y, legendItem) {
            ...
            const lineWidth = valueOrDefault$d(legendItem.lineWidth, lineDefault.borderWidth);
 ...
 */
    const Title = core_element.extend({
      ...
      fit: function() {
        ...
        const display = opts.display;
        const minSize = me.minSize;
        const lineCount = helpers$1.isArray(opts.text) ? opts.text.length : 1;
        const fontOpts = helpers$1.options._parseFont(opts);
        const textSize = display ? (lineCount * fontOpts.lineHeight) + (opts.padding * 2) : 0;
      ...
      draw: function() {
        ...
        if (opts.display) {
          ...
          let maxWidth; let titleX; let titleY;
